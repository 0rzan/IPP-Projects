 ...
 *         Michał Orżanowski <mo439981@students.mimuw.edu.pl>
...
/** @brief Jest funkcją odwrotna do phfwdGet.
 * która dla podanej za pomocą wskaźnika @p pf bazy przekierowań i podanego numeru
 * telefonu num wyznacza posortowaną leksykograficznie listę wszystkich takich 
 * numerów telefonów i tylko takich numerów telefonów 
 * @p x, że @p phfwdGet z numerem @p x równy jest @p num. 
 * Funkcja ta alokuje strukturę @p PhoneNumbers, która musi być zwolniona za pomocą 
 * funkcji phnumDelete. Wynikiem funkcji jest NULL, gdy nie udało się alokować pamięci. 
